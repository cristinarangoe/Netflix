  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger>
        <a
          onClick={gaTracker}
          className="outline-none visited:outline-none focus-visible:outline-none"
        >
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="bg-[hsla(0, 0%, 0%, 0.439)] bg-fixed inset-0 outline-none visited:outline-none focus-visible:outline-none" />
        <Dialog.Content className="focus-visible:outline-none  outline-none  visited:outline-none overflow-y-auto overscroll-x-none fixed bg-black rounded-[6px] top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] w-[90vw] max-w-[450px] lg:w-[200vw] lg:max-w-[700px] max-h-[85vh] p-[25px]">
          <div>
            <div>
              <img
                src={content.image}
