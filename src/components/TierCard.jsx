...
export default function TierCard({ name, info, onClick }) {
  ...
  return (
    <div>
      <button>
        {tier === currentTier ? <button onClick={onClick} className="block bg-white rounded-lg border shadow-md   ">
        <div className='left-0 top-0'>
          ...
          <p class="mb-2 text-2xl font-bold tracking-tight  dark:text-red-600 ">{title}
          ...
          <button onClick={onClick} className="block bg-red-500/30 rounded-lg border shadow-md ">
